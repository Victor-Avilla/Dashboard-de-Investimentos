...
function Header() {
    return (
        <section className='flex justify-between items-center px-5 bg-slate-900 border-b border-slate-800'> {/* bg do header */}
            {/* itens a esquerda */}
            <div className='flex items-center pb-5 pt-5 gap-x-3'>                 
            ...
            {/* itens a direita */}
            <div className='flex items-center pb-5 pt-5 min-w-0 flex-grow justify-end'> 
                <input type="text" placeholder='Busque por um ativo' className='grow max-w-xs min-w-0 text-white bg-slate-950 rounded-md border border-slate-800 placeholder-slate-500 p-1' />
